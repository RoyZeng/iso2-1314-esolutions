...
public class AgenteProducto {
	public void insertProducto(Producto producto){
		//INSERT INTO Producto VALUES (0,'pescado',12,'hola','2013-12-20');
		String sentence="INSERT INTO Producto VALUES (0,'"+producto.getNombre()+"',"+producto.getCantidad()+",'"+producto.getTipo()+"','"+producto.getFecha()+"');";
