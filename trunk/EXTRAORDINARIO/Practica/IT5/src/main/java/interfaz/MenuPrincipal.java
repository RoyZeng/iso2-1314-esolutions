...
public class MenuPrincipal {
	...
	private void initialize() {
		...
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		{
			...
			JButton btnComprobarMercancia = new JButton("Comprobar mercancia");
			btnComprobarMercancia.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					//ComprobarMerc principal=new ComprobarMerc();
					//principal.mostrar();
				}
			});
			btnComprobarMercancia.setBounds(205, 278, 163, 23);
			Index.add(btnComprobarMercancia);
		}
	}
}